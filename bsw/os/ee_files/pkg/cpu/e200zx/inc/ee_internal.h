...
#include "../../common/inc/ee_primitives.h"

/* Common Context Handling implementation */
#include "../../common/inc/ee_context.h"
...
#if (defined(__MSRP__)) || ((defined(__EE_MEMORY_PROTECTION__)) && ((defined(__OO_BCC1__)) || (defined(__OO_BCC2__)) || (defined(__OO_ECC1__)) || (defined(__OO_ECC2__))))
...
extern int stby_sram_base;
extern int stby_sram_len;
extern int isram_base;
extern int isram_len;
extern int ee_ssbss2;
extern int ee_esbss2;
extern int cal_sram_base;
extern int cal_rom_base;
extern int cal_sram_end;
