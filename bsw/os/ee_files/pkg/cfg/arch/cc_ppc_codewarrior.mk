...
MWStartupIncludes ?= $(CW_SUPPORTDIR)/ewl/EWL_Runtime/Runtime_PA/Include
...
INCLUDE_PATH += $(MWStartupIncludes)
...
#TODO: check why double def
#SPE Support
#ifeq ($(call iseeopt, __SPE__),yes)
OPT_CC += -spe_vector
#endif
