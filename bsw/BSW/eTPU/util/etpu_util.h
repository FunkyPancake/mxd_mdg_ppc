...
* Type Definitions
*******************************************************************************/
typedef uint32 ufract24_t;
typedef sint32 fract24_t;

typedef uint32 uint24_t;
typedef sint32 int24_t;
...
uint8 fs_etpu_get_chan_interrupt_overflow_flag(
    uint8 channel);
...
uint8 fs_etpu_get_chan_dma_overflow_flag(
    uint8 channel);
...
uint8 fs_etpu_get_chan_dma_oveflow_flag(uint8 channel);
uint8 fs_etpu_get_chan_interrupt_oveflow_flag(
    uint8 channel);
void fs_etpu_clear_chan_dma_oveflow_flag(uint8 channel);
/* Others */
uint32 *fs_memcpy32(
    uint32 *dest,
    uint32 *source,
