...
{
  const uint8  chan_num;  /**< Channel number of the FUEL channel. */
  const uint8  priority;  /**< Channel priority for the FUEL channel. */
  const uint8  polarity;  /**< FUEL polarity. It can one any of:
...
{
  uint8  error;     /**< This is the error status of FUEL. It may
...
*******************************************************************************/
/* Initialize */
uint32 fs_etpu_fuel_init(
  struct fuel_instance_t   *p_fuel_instance,
  struct fuel_config_t     *p_fuel_config);

/* Change configuration */
uint32 fs_etpu_fuel_config(
  struct fuel_instance_t *p_fuel_instance,
  struct fuel_config_t   *p_fuel_config);

/* Update injection time */
uint32 fs_etpu_fuel_update_injection_time(
  struct fuel_instance_t *p_fuel_instance,
  struct fuel_config_t   *p_fuel_config);

/* Get states */
uint32 fs_etpu_fuel_get_states(
  struct fuel_instance_t *p_fuel_instance,
